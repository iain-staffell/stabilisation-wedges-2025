...
#####                                                   #####
#############################################################
#####      29-07-2025       #####     IAIN STAFFELL     #####
#############################################################


# convert a list of vectors into a padded data.frame
# and save as csv
...
monte_carlo = function(N, mean, min=NULL, max=NULL)
{
	...
	constrained_distro('rnorm', N, min=min, max=max, mean=mean, sd=(max-min)/1.96)
}
...
##
##  simple plot functions for lazy fuckers like me
##
